...
# ... (kode get_table, get_table_by_name, get_tables tetap sama) ...
...
def create_table(table: schemas.TableCreate):
    # Fungsi ini sekarang hanya bertugas untuk memasukkan data.
    # Tidak perlu lagi membaca kembali data yang baru dimasukkan.
...
# ... (sisa kode CRUD untuk pesanan tetap sama) ...
